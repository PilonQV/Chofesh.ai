import { int, mysqlEnum, mysqlTable, text, timestamp, varchar, bigint, boolean, index, date } from "drizzle-orm/mysql-core";
...
export const users = mysqlTable("users", {
  ...
  dateOfBirth: date("dateOfBirth"), // For age verification
