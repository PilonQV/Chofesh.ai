          ...
          <div className="flex h-full flex-col p-4">
            <div className="flex flex-1 flex-col items-center justify-center gap-6 text-muted-foreground">
              <div className="flex flex-col items-center gap-3">
                <img src="/chofesh-logo-48.webp" alt="Chofesh AI Logo" className="size-12 opacity-20" />
                  ...
                  >
                    {message.role === "assistant" && (
                      <div className="size-8 shrink-0 mt-1 rounded-full bg-primary/10 flex items-center justify-center">
                        <img src="/chofesh-logo-48.webp" alt="Chofesh AI" className="size-5" />
                      </div>
                    )}
                    ...
                    <div
                      className={cn(
                        "rounded-lg",
                        message.role === "user"
                          ? "max-w-[85%] md:max-w-[80%] bg-primary text-primary-foreground px-4 py-2.5"
              ...
              {isLoading && (
                ...
                >
                  ...
                  <div className="rounded-lg bg-muted px-4 py-2.5">
                    <img src="/chofesh-logo-48.webp" alt="AI thinking" className="size-4 animate-pulse" />
                  </div>
                </div>
              )}
            </div>
